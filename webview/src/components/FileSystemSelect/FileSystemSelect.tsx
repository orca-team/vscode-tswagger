...
import styles from "./FileSystemSelect.less";
...
export interface FileSystemSelectProps extends TreeSelectProps {}

const FileSystemSelect: React.FC<FileSystemSelectProps> = (props) => {
